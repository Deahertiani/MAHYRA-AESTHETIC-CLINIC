...
>
    ...
    <span>Daftar Dengan Apple</span>
                    ...
                    <button
    class="w-full px-4 py-3 bg-gradient-to-r from-[#F9D4D4] to-[#FFF4F4] text-gray-700 rounded-lg font-medium flex items-center justify-center gap-3 hover:from-[#F6C1C1] hover:to-[#FFECEC] transition"
>
